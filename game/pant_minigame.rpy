...
label pant_minigame:
    ...
    # Show the intermission screen first
    scene bg pant_intermission
    with fade
...
screen pant_game():
    ...
    if show_results:
        ...
        frame:
            ...
            vbox:
                ...
                text "Game Complete!" size 50 xalign 0.5 color "#fff"
                
                if player_score >= 10:
                    text "Great job! You earned [player_score] kroner from panting!" color "#fff" xalign 0.5
                    text "You're a natural at recycling!" color "#fff" xalign 0.5
                elif player_score >= 5:
                    text "Not bad! You earned [player_score] kroner from panting." color "#fff" xalign 0.5
                    text "With a bit more practice, you'll be a panting expert!" color "#fff" xalign 0.5
                else:
                    text "You earned [player_score] kroner from panting." color "#fff" xalign 0.5
                    text "Keep practicing to learn which bottles are pantable!" color "#fff" xalign 0.5
                
                text "Thanks for playing the pant sorting game!" color "#fff" xalign 0.5
    ...
    # Check if game is finished but results not yet shown
        ...
        textbutton "See Results" action Function(show_game_results) xalign 0.5 yalign 0.85 xpadding 40 ypadding 20

    # Gameplay elements - only shown when game is still in progress
    else:
        draggroup:
            # ========== PANT ZONE POSITION - ADJUST THESE VALUES ==========
            # Pant zone on the left (droppable) - modify xpos/ypos to position
            drag:
                drag_name "pant_zone"
                xpos 50  # LEFT POSITION - CHANGE THIS VALUE
                ypos 360  # VERTICAL POSITION - CHANGE THIS VALUE
            ...
            # ========== DISCARD ZONE POSITION - ADJUST THESE VALUES ==========
            # Discard zone on the right (droppable) - modify xpos/ypos to position
            drag:
                drag_name "discard_zone"
                xpos 1600  # RIGHT POSITION - CHANGE THIS VALUE
                ypos 360   # VERTICAL POSITION - CHANGE THIS VALUE
                draggable False  # This is a drop target, not draggable
            ...
            # ========== BOTTLE POSITION - ADJUST THESE VALUES ==========
        ...
        # Instructions
        text "Drag the bottle to PANT or DISCARD" size 25 xalign 0.5 ypos 650
